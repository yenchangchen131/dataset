...
| **2WikiMultiHopQA** | 多跳 | 20 | 英文翻譯為繁中 (含干擾項) |
| **總計** | - | **60** | |

**題型分佈**：
- **單跳 (Single-hop)**：20 題 (33%) — 僅需單一文檔即可回答
- **多跳 (Multi-hop)**：40 題 (67%) — 需整合多篇文檔資訊

### 文檔庫 (Corpus)

- **總計**：600 篇
  - **Gold Contexts**：~100 篇 (正解文檔)
  - **Hard Negatives**：~400 篇 (高相似度干擾項)
  - **Random Negatives**：~100 篇 (隨機干擾項)
...
│   ├── verify_data.py     # [Step 3] 驗證
│   └── replace_question.py # [Step 4] 問題抽換
├── docs/
│   └── Spec.md            # 詳細規格書
